...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom{
    ...
    private BooleanExpression searchSellStatusEq(ItemSellStatus searchSellStatus) {
        ...
        // ItemSellStatus null이면 null리턴, 아니면 SELL or SOLD_OUT 리턴
    }
    ...
    private BooleanExpression searchByLike(String searchBy, String searchQuery) {
        if (!StringUtils.isEmpty(searchQuery)) {
            if (StringUtils.equals("itemNm", searchBy) || StringUtils.isEmpty(searchBy)) { // 상품명
    ...
    @Override
    public Page<MainItemDto> getDisplayPage(ItemSearchDto itemSearchDto, Pageable pageable) {
        QItem item = QItem.item;
        QItemImg itemImg = QItemImg.itemImg;
