...
public class ItemService {
    ...
    public ItemFormDto getItemDtl(Long itemId) {
        ...
        // Item -> ItemFormDto  modelMapper로 변환
    ...
    @Transactional(readOnly = true)
    public ItemFormDto cartItemDtl(Long cartItemId) {
        CartItem findCartItem = cartItemRepository.findById(cartItemId)
                .orElseThrow(EntityNotFoundException::new);
        Item findItem = findCartItem.getItem();
        return getItemDtl(findItem.getId());
    }
    @Transactional(readOnly = true)
    public Page<MainItemDto> getDisplayList(ItemSearchDto itemSearchDto, Pageable pageable) {
        return itemRepository.getDisplayPage(itemSearchDto, pageable);
    }
}
